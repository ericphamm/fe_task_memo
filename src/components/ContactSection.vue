        ...
        <div>
          ...
          <div class="space-y-8">
            ...
            <div class="flex items-center space-x-4">
              ...
              <p class="text-white text-base  font-normal">info@designmodo.com</p>
            </div>
            ...
            <div class="flex items-start space-x-4">
				...
				<div>
                <p class="text-white text-base font-normal">San Francisco, CA560 Bush St & <br />
        ...
        <div class="bg-white rounded-[10px] px-12 py-20">
			<form @submit.prevent="submitForm" class="space-y-6">
                ...
                <div class="md:col-span-3">
                  <label for="name" class="block text-sm font-bold mb-2 uppercase tracking-wider text-[#1E0E62]">Your Name</label>
				          <input
                  id="name"
                  v-model="form.name"
                  type="text"
               ...
               <div class="md:col-span-2">
                 ...
                 <label for="budget" class="block text-sm font-bold mb-2 uppercase tracking-wider text-[#1E0E62]">Budget</label>
                 <div class="relative">
                  <select
      id="budget" 
      v-model="form.budget"
...
<!-- email -->
             <div>
              <label for="email" class="block text-sm font-bold mb-2 uppercase tracking-wider text-[#1E0E62]">Input Field</label>
              <input
                id="email"
                v-model="form.email"
                type="text"
            ...
            <!-- message -->
            <div>
              <label for="message" class="block text-sm font-bold mb-2 uppercase tracking-wider text-[#1E0E62]">Your Message</label>
              <textarea
                id="message"
                v-model="form.message"
                rows="4"
                :class="['input-field resize-none h-[110px] rounded-[10px]', errors.message && 'border-red-500']"
                class="input-field resize-none h-[110px] rounded-[10px]"
                placeholder="Message"
              />
    ...
    <div 
      ...
      :class="sendCopy ? 'bg-[#25DAC5] border-[#25DAC5]' : 'border-gray-300'"
    >
      <Check 
        class="w-4 h-4 text-[#1E0E62] transition-opacity duration-200"
...
>
  Send
            ...
            <div v-if="showSuccess" class="bg-green-100 border border-green-400 text-green-700 px-4 py-3 rounded-full mt-4">
  ...
  const budgetOptions = ['$500', '$1,000', '$2,500', '$5,000', '$10,000+']
