<template>
  <div class="relative w-full m-h-[600px] flex items-center justify-center px-4 text-white overflow-hidden">
    <div class="flex flex-col mx-auto items-center space-y-14 py-4">
      <!-- slides -->
      <div class="flex transition-transform duration-700 ease-in-out w-full max-w-6xl"
