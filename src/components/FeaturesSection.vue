  ...
  >
    ...
    <div class="z-10 relative flex flex-col lg:flex-row items-center justify-start gap-10 w-full">
      ...
      <div class="hidden lg:flex flex-[0.4] sticky top-20 justify-start">
        <img
          src="/src/assets/images/features_laptop.svg"
          class="w-full mx-auto h-[200px] md:h-[400px] lg:h-[535px]"
        />
      </div>
  ...
  features: [
    {
      ...
      description: 'Assign roles, track progress, and share feedback in one unified environment.',
    },
    {
      icon: Puzzle,
      title: 'CROSS-PLATFORM ACCESS',
      description: 'Access your projects from any device with full responsiveness and sync.',
    },
  ],
},
  {
    ...
    features: [
      ...
      },
      {
        ...
        description: 'Speed up your design process with smart components and reusable patterns.',
      },
    ],
  },
  {
